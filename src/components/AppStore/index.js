...
class AppStore extends Component {
  ...
  getAppBasedOnSearchInput = event => {
    this.setState({
        ...
        <div className="app-content-container">
          ...
          <div className="search-container">
            <input
              ...
              value={userInput}
              onChange={this.getAppBasedOnSearchInput}
            />
            <img
          ...
          <ul className="app-list-container">
            {searchResults.map(eachAppDetails => (
              <AppItem appDetails={eachAppDetails} key={eachAppDetails.appId} />
            ))}
          </ul>
        </div>
      </div>
